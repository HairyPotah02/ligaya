...
async def heck_dat(_, message: Message):
    ...
    hack_animation_stage3_chars = [
        "**[root@Ligaya-Ub]** `tg-hacker start --use-tg-brut --less-verbose --auto-cmd` \n",
        "`>> Starting the hack...` \n",
        "`>> Downloading Telegram-Bruteforce-8.3.2.tar.gz (1.9MiB)` \n"
        "`>> Download Completed ✓` \n\n",
        "**[root@Ligaya-Ub]** `tg-hacker --check-config` \n",
        "`>> Checking user config file...` \n"
        f"`>> Found config file - {user_id}.conf` \n",
        "**[root@Ligaya-Ub]** `tg-hacker --upload` \n",
    ...
    hack_animation_stage4_chars = [
        "**[root@Ligaya-Ub]** `tg-hacker check-if-completed` \n",
        "`>> Checking...` \n"
        "`>> Hacking completed ✓` \n\n",
        "**[root@Ligaya-Ub]** `tg-hacker show --fix-for-tg-msg` \n\n\n",
    ...
    await heck_msg.edit(f"{stage2_msg} \n\n**[root@Ligaya-Ub]** `clear && tg-hacker --set-stage stage3`")
    ...
    await heck_msg.edit(f"{actual_prgs_msg} \n**[root@Ligaya-Ub]** `clear && tg-hacker --set-stage stage4`")
